...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- ROW-1 -->
        <div class="row">
            <div class="col-sm-12 col-lg-12 col-xl-5 col-xxl-4">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center py-3 flex-wrap">
                                ...
                                <div class="ms-3 flex-grow-1">
                                    ...
                                    <h5 class="fw-semibold mb-0 mt-1">$27, 874</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center py-3 flex-wrap">
                                ...
                                <div class="ms-3 flex-grow-1">
                                    ...
                                    <h5 class="fw-semibold mb-0 mt-1">35, 889+</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center py-3 flex-wrap">
                                ...
                                <div class="ms-3 flex-grow-1">
                                    ...
                                    <h5 class="fw-semibold mb-0 mt-1">12, 557+</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center py-3 flex-wrap">
                                ...
                                <div class="ms-3 flex-grow-1">
                                    ...
                                    <h5 class="fw-semibold mb-0 mt-1">$88, 984</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row py-2 justify-content-center">
                            ...
                            <div class="col-3 d-flex align-items-center justify-content-center flex-wrap">
                                ...
                                <span class="badge bg-danger-transparent"><i
                                        class="bx bx-trending-down me-1"></i>13%</span>
                            </div>
                        </div>
                        <div id="earnings"></div>
                    </div>
