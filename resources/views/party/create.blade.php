                    ...
                    <div class="card-body gy-4">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                ...
                                <input type="tel" id="inputshort" class="form-control" name="phone_no" value="{{ old('phone_no') }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                ...
                                <input type="text" id="inputGst" class="form-control" name="gst_no" value="{{ old('gst_no') }}">
                            </div>
                        </div>
                
                        <div class="row mb-2">
                            <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                <label for="contact_person_id" class="col-form-label">Cont.Person</label>
                            ...
                            <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                <label for="owner_id" class="col-form-label">Owner Name</label>
