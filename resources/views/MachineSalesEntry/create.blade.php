                        ...
                        <form action="{{ route('MachineSales.store') }}" method="POST" id="MachineSales-form">
                            ...
                            <div class="row mb-1">
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <input type="text" id="inputBill" class="form-control" name="bill_no" value="{{ old('bill_no') }}" />
                                </div>
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    <label for="input-Date" class="form-label">Date</label>
                                    <input type="date" class="form-control" placeholder="yy/mm/dd" name="date" value="{{ old('date') }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <select class="form-control" data-trigger name="party_id">
                                        ...
                                        @foreach (App\Models\Party::all() as $item)
                                            <option value="{{ $item->id }}" @if(old('party_id') == $item->id) selected @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                            ...
                            <div class=" row mb-1">
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <input type="text" id="inputProdsr" class="form-control" name="order_no" value="{{ old('order_no') }}" />
                                </div>
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    <label for="inputM/C" class="col-form-label">M/c No.</label>
                                    <input type="text" id="inputM/C" class="form-control" name="mc_no" value="{{ old('mc_no') }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <input type="date" class="form-control" placeholder="yy/mm/dd" name="install_date" value="{{ old('install_date') }}">
                                </div>
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    <label for="inputExpiry" class="col-form-label">Expiry Date</label>
                                    <input type="date" class="form-control" placeholder="yy/mm/dd" name="service_expiry_date" value="{{ old('service_expiry_date') }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <select class="form-control" data-trigger name="service_type_id">
                                        ...
                                        @foreach (App\Models\ServiceType::all() as $item)
                                            <option value="{{ $item->id }}" @if(old('service_type_id') == $item->id) selected @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                            ...
                            <div class="row mb-1">
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <input type="text" id="inputOrder" class="form-control" name="order_no" value="{{ old('order_no') }}" />
                                </div>
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    <label for="inputOrder" class="col-form-label">Remark </label>
                                    <input type="text" id="inputOrder" class="form-control" name="remark" value="{{ old('remark') }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <select class="form-control" data-trigger name="mic_fitting_engineer_id" value="{{ old('mic_fitting_engineer_id') }}">
                                ...
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <select class="form-control" data-trigger name="delivery_engineer_id" value="{{ old('delivery_engineer_id') }}">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <input type="text" id="inputParty" class="form-control" name="map_url" value="{{ old('map_url') }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-1">
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="switch-sm" name="is_active">
