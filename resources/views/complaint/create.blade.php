                    ...
                    <form action="{{ route('complaints.store') }}" method="POST" id="complaint-form">
                        ...
                        <div class="row mb-1">
                            <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                ...
                                <select class="form-control" name="service_type_id" id="service_type_id">
                                    ...
                                    <option value="{{ $item->id }}" {{$loop->first ? 'selected' : ''}}>{{ $item->name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                ...
                                <select class="form-control" name="status_id" id="status_id">
                                    ...
                                    <option value="{{ $item->id }}" @if ($item->name == 'Pending') selected @endif>{{
                                        $item->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-1">
                            <div class="form-group col-xl-6 col-lg-6 col-md-8 col-sm-12">
                                ...
                                <textarea type="text" id="remark" class="form-control" name="remarks"
                                    aria-describedby="nameHelpInline"> </textarea>
                            </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-1">
                                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                                ...
                                                <input type="date" class="form-control" placeholder="yy/mm/dd"
                                                    name="engineer_in_date" id="engineer_in_date" value="">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6.col-sm-12 mb-1">
                                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                                ...
                                                <input type="time" class="form-control" placeholder="hh:mm"
                                                    name="engineer_in_time" id="engineer_in_time" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-1">
                                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                                <label for="inputDate" class="col-form-label">Engineer Out
                                                    Date</label>
                                                <input type="date" class="form-control" placeholder="yy/mm/dd"
                                                    id="engineer_out_date" name="engineer_out_date" value="">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-1">
                                            <div class="collapse multi-collapse" id="multiCollapseExample1">
...
<script type="text/javascript">
    $(document).ready(function() {
            ...
            $('#engineer_out_date').on('change', function() {
                ...
                const formattedOutTime = `${hours < 10 ? '0' : ''}${hours}:${minutes < 10 ? '0' : ''}${minutes}`;
